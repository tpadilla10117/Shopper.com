...
const SlidingSidebar = () => {
	...
	return (
		<CSSTransition
			...
			onEnter={() => navToggle}
			onExited={() => navToggle}
			classNames='slidingsidebar-transition'
			nodeRef={nodeRef}
		>
			<nav className='slidingsidebar-parent-container' ref={nodeRef}>
				<div className='slidingsidebar-icon-container' onClick={navToggle}>
					{/* TODO: svg className='close-icon' */}
				</div>

				<div className='slidingsidebar-wrapper'>
					<ul className='slidingsidebar-menu'>
						<div className='slidingsidebar-link'>
